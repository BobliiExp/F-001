...
/**
 Asks the data source for a custom view with buttons displayed on instead of default button
 Use this method to show an activity view indicator for loading feedback, or for complete custom empty data set.
 
 @param scrollView A scrollView subclass object informing the delegate.
 @return The custom view with buttons.
 */
- (UIView *)customViewButtonsForEmptyDataSet:(UIScrollView *)scrollView;
