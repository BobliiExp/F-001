...
@class PYIMAudioController;
@protocol PYIMAudioControllerDelegate <NSObject>

/**
 用于控制声波变化的通知
 */
- (void)audioController:(PYIMAudioController*)controller soundWaveChanged:(NSMutableArray*)points;
...
@property (nonatomic, assign) id<PYIMAudioControllerDelegate> delegate;   
