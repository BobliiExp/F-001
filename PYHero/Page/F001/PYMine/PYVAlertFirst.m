...
- (void)setupUI {
    ...
    labContent.text = KLocalizable(@"welcomeContent");
    ...
    btnSetting.tag = 10;
    [btnSetting setTitle:KLocalizable(@"goSet") forState:UIControlStateNormal];
    ...
    btnPoint.tag = 11;
    [btnPoint setTitle:KLocalizable(@"knowPoint") forState:UIControlStateNormal];
